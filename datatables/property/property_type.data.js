...
import { 
    ...
    DeleteData,
    updateData,
        } from "../../api/property/property_type.api"
...
const [property_type_name, setPropertyTypeName] = useState('');
const [property_type_description, setPropertyTypeDescription] = useState('');
 ...
 //-------------------------| HANDLE for MODALS Editing Viewing |----------------------------- 
    const handleEdit = async (data) => {
        ...
        if (viewdata1.status === 200) {
            ...
            setPropertyTypeName(viewdata1.data.property_type_name)
            setPropertyTypeDescription(viewdata1.data.property_type_description)
        }
        } catch (error) {
        console.error("Error fetching user:", error);
        }
    ...
    const editChange = async (value, field) => {
        ...
        switch(field){
            ...
            setPropertyTypeName(value)
            break;

            case 'property_type_description': 
            setPropertyTypeDescription(value)
            break;
    ...
    return(
       <>      
        <Divider orientation="right">
                  ...
                  onClick={showModal}
                  >
                     < PlusCircleOutlined />     Add New Property Type
                  </Button>
                  <Divider type="vertical" />
        </Divider>
      ...
      {/* ----------------------------------------------| Modal for Editing Datas |---------------------------------------------------  */}
            ...
            >
             ...
             <Divider><h3 style={{color: "Blue"}}>Edit Data</h3></Divider>
              <Row gutter={16}>
                    <Col span={24}>
                        <b> Property Type Name:</b>   <br/>
                           <Paragraph
                            editable={{
                                onChange: (updatedValue) => editChange(updatedValue, 'property_type_name'),
                            }}
                        >
                            {property_type_name}
                        </Paragraph>
              ...
              <Row gutter={16}>
                <Col span={24}>
                                <b>Property Type Description:</b>   <br/>
                                <Paragraph
                                editable={{
                                    onChange: (updatedValue) => editChange(updatedValue, 'property_type_description'),
                                }}
                                >
                                {property_type_description}
                            </Paragraph>
  ...
  {/* ----------------------------------------------| Modal for Viewing Datas |---------------------------------------------------  */}
            ...
            >
             <Divider><h3 style={{color: "green"}}>Viewing Data</h3></Divider>
              <Row gutter={16}>
                    <Col span={24}>
                        <b> Property Type Name:</b>   <br/>
                           {viewData?.property_type_name}  
                    </Col>
              </Row> <br/>
              <Row gutter={16}>
                    <Col span={24}>
                        <b>Property Type Description:</b>   <br/>
                            {viewData?.property_type_description}
                    </Col>
              </Row> <br/>
              <Row gutter={16}>
                    <Col span={24}>
       ...
       <Modal
                ...
                >
                    ...
                    <Divider><h3 h3 style={{color: "purple"}}>Adding new Property Type</h3></Divider>
                            <Form
                              form={formAdd}
                              labelCol={{ span: 6 }}
                              wrapperCol={{ span: 14 }}
